...
==== Internet Archive
Eligible archive.org items may be linked to the corresponding Open Library record. The archive.org item's Identifier may be entered into this field. Always check that the archive.org item does not already have Open Library IDs noted on the record. Patron-uploaded items are not eligible and may not be linked from Open Library.
