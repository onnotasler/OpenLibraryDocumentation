...
image:images/Librarians-EditEditions-Tabs.png["Screenshot showing Editing, Things They Lost, by Okwiri Oduor, WORK DETAILS, Scribner edition, 2022. Scribner edition, 2022 is surrounded by a blue box."]
...
The date when a specific edition was released to the public. You should usually find it in the imprint at the first few pages of the books -- usually a line that contains a year preceded by _this printing_ or something similar.
