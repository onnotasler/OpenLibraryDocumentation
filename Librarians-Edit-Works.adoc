...
An **award** is a special kind of collection, which includes winners or nominees for certain literature focussed awards.

Those are marked with the tag [award:Name_Of_Award=categorie].

Otherwise, awards work just like other collections.

==== A person? Or, people?

This can be any individual or group of individuals. If a name describes several persons, you should add qualifiers like date of birth, date of death, or occupation. You may also enter fictional, legendary or mythic names. Qualifiers should be added in parantheses after the name.

====
:example:

* عائشة بنت يوسف الباعونية (Sufi mystic, ? - 1517)
